...
set ::env(CELL_CDLS) /foss/pdks/sky130A/libs.ref/sky130_fd_sc_hd/cdl/sky130_fd_sc_hd.cdl
...
set ::env(PNR_SDC_FILE) /foss/designs/Microdesafio3/src/constraints.sdc
set ::env(DEDUPLICATE_CORNERS) 0
set ::env(STA_MACRO_PRIORITIZE_NL) 1
set ::env(SIGNOFF_SDC_FILE) /foss/designs/Microdesafio3/src/constraints.sdc
set ::env(CURRENT_NL) /foss/designs/Microdesafio3/runs/RUN_2025-11-21_07-44-22/52-openroad-fillinsertion/chipi.nl.v
set ::env(CURRENT_SPEF) "\"nom_*\" /foss/designs/Microdesafio3/runs/RUN_2025-11-21_07-44-22/54-openroad-rcx/nom/chipi.nom.spef \"min_*\" /foss/designs/Microdesafio3/runs/RUN_2025-11-21_07-44-22/54-openroad-rcx/min/chipi.min.spef \"max_*\" /foss/designs/Microdesafio3/runs/RUN_2025-11-21_07-44-22/54-openroad-rcx/max/chipi.max.spef"
set ::env(CURRENT_ODB) /foss/designs/Microdesafio3/runs/RUN_2025-11-21_07-44-22/53-odb-cellfrequencytables/chipi.odb
set ::env(SAVE_SDC) /foss/designs/Microdesafio3/runs/RUN_2025-11-21_07-44-22/55-openroad-stapostpnr/chipi.sdc
